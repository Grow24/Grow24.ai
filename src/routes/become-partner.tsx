...
const SECTION_IDS = ['identify', 'benefits', 'journey', 'faq'] as const
...
function BecomePartnerPage() {
  ...
  const highlightedTab = activeTab !== 'all' ? activeTab : (scrollSpyTab ?? 'all')
        ...
        {activeTab === 'all' && (
          <div className="space-y-12">
            <section id="identify" className="scroll-mt-header space-y-10">
              <div className="rounded-2xl overflow-hidden bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-700 shadow-sm p-6 sm:p-8 md:p-10 flex flex-col md:flex-row items-center gap-6 md:gap-10">
            ...
            <section id="benefits" className="scroll-mt-header max-w-5xl mx-auto">
            ...
            <section id="journey" className="scroll-mt-header max-w-5xl mx-auto">
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-8">
                Partner journey (Apply → Verify → Enable → Co-sell → Deliver → Grow)
              </h2>
            ...
            <section id="faq" className="scroll-mt-header max-w-3xl mx-auto">
