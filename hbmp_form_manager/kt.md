...
python -c "import json; questions = json.load(open('cleaned_questions.json')); [q.update({'theme': 'Reading Comprehension'}) for q in questions if 'theme' not in q]; json.dump(questions, open('cleaned_questions_latex_themed.json', 'w'), indent=2, ensure_ascii=False)"
...
*This knowledge transfer document is a living document and should be updated as the project evolves.*
