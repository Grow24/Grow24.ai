...
import HbmpOfficeViewer from './pages/OfficeViewer/HbmpOfficeViewer';
    ...
    <QueryClientProvider client={queryClient}>
      <BrowserRouter>
        <Routes>
          ...
          {/* Office Viewer - full screen without AppShell */}
          <Route path="/projects/:projectId/office/:fileId" element={<HbmpOfficeViewer />} />
        </Routes>
        <Toaster />
      </BrowserRouter>
    </QueryClientProvider>
