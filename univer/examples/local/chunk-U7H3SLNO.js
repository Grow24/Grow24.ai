...
function useLocale() {
  ...
  async function loadLocales(value) {
    ...
    switch (value) {
      case "zhCN" /* ZH_CN */:
        locales2 = await import("/univer/zh-CN-DDPOHHYD.js");
        break;
      case "zhTW" /* ZH_TW */:
        locales2 = await import("/univer/zh-TW-3OFHSDVW.js");
        break;
      case "frFR" /* FR_FR */:
        locales2 = await import("/univer/fr-FR-BFIR5N2C.js");
        break;
      case "ruRU" /* RU_RU */:
        locales2 = await import("/univer/ru-RU-SVJGROK4.js");
        break;
      case "viVN" /* VI_VN */:
        locales2 = await import("/univer/vi-VN-OM2YIUU3.js");
        break;
      case "jaJP" /* JA_JP */:
        locales2 = await import("/univer/ja-JP-OUVEY47K.js");
        break;
      case "koKR" /* KO_KR */:
        locales2 = await import("/univer/ko-KR-HQSM5TP5.js");
        break;
      case "es-ES":
        locales2 = await import("/univer/es-ES-EM2USPAG.js");
        break;
      case "ca-ES":
        locales2 = await import("/univer/ca-ES-H4C75SE6.js");
        break;
      case "enUS" /* EN_US */:
      default:
        locales2 = await import("/univer/en-US-PG35IPJL.js");
        break;
    }
    localeService.load({
...
function useSnapshot() {
  ...
  const onSelect = async (value) => {
    ...
    if (!workbook) {
      ...
      if (true) {
        const gitHash = "4089c22";
        const gitBranch = "main";
        const buildTime = "2026-03-23T04:18:39.004Z";
